...
y<- Animal_ID
z<- Animal_ID
Yorkshirepedigree.file<- mutate(Landracepedigree.file, y)
Yorkshirepedigree.file<- mutate(Landracepedigree.file, z)
...
Yorkshirepedigree.file<- select(Landracepedigree.file, "Sex", "Sire", "Dam", "Birthdate")
